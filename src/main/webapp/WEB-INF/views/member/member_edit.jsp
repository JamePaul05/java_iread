            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form:form class="form-horizontal" commandName="member" method="post"
                               action="${pageContext.request.contextPath }/admin/member/save?type=edit" id="barForm">
                        <form:hidden path="id" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <form:input path="registerTime" class="form-control" readonly="true" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <form:input path="payTime" class="form-control" readonly="true" />
                            </div>
                        </div>
