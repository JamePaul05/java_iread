...
<script>
    ...
    $(document).ready(function(){
        datatable = $('#datatable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "${pageContext.request.contextPath }/admin/role/fetchRoles",
            },
    ...
    function fnClickAddRow(){
        location.href='${pageContext.request.contextPath}/admin/role/create';
    }

    function editById(id) {
        //停止事件
        event.stopPropagation();
        window.location.href = "${pageContext.request.contextPath}/admin/role/edit/" + id;
    }
    ...
    function delById(id){
        ...
        swal({
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/admin/role/remove",
                cache: false,
                async: false,
                dataType: "json",
                data: {
