...
<script>
    ...
    $(document).ready(function(){
        datatable = $('#datatable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
              url: "${pageContext.request.contextPath }/admin/user/fetchUsers",
            },
    ...
    function fnClickAddRow(){
        location.href='${pageContext.request.contextPath}/admin/user/create';
    }
    ...
    function delById(id){
        ...
        swal({
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/admin/user/remove",
                cache: false,
                async: false,
                dataType: "json",
                data: {
