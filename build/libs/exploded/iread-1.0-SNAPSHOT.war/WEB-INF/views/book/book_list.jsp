...
<script>
    ...
    $(document).ready(function(){
        datatable = $('#datatable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "${pageContext.request.contextPath }/admin/book/fetchBooks",
            },
    ...
    function fnClickAddRow(){
        location.href='${pageContext.request.contextPath}/admin/book/create';
    }

    function editById(id) {
        //停止事件
        event.stopPropagation();
        window.location.href = "${pageContext.request.contextPath}/admin/book/edit/" + id;
    }
