...
<script>
    ...
    $(document).ready(function(){
        datatable = $('#datatable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "${pageContext.request.contextPath }/admin/menu/fetchMenus",
            },
    ...
    function fnClickAddRow(){
        location.href='${pageContext.request.contextPath}/admin/menu/create';
    }

    function editById(id) {
        //停止事件
        event.stopPropagation();
        window.location.href = "${pageContext.request.contextPath}/admin/menu/edit/" + id;
    }
    ...
    function delById(id){
        ...
        swal({
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/admin/menu/remove",
                cache: false,
                async: false,
                dataType: "json",
                data: {
